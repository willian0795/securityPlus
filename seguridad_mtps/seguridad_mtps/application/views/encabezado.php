            ...
            <div class="container" id="container">
				...
				<div class="sidebar-right-heading" id="tabs">
					<h3>Ayuda</h3>	
					  ...
					  <div id="tabs-1">
					  	<p ><strong> DESCRIPCIÓN DE LA PANTALLA</strong></p>
					  	<?php  echo "<p class='descrip'>".$descripcion_ayuda['descripcion_ayuda']." </p>"; ?>
					  	
					  	<p ><strong> ¿PARA QUE SE NECESITA ESTA INFORMACIÓN? </strong></p>
					 	<?php  echo "<p class='descrip'>". $descripcion_ayuda ['para_que']."</p>";?>
					 	<?php  echo '<p class="descrip"><a href="'.base_url().'ayuda/'.$id_modulo.'.pdf" target="_blank">Más información</a></p>';?>
