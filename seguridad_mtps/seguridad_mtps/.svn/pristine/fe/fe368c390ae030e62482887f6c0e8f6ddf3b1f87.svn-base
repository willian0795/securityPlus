...
class Usuarios extends CI_Controller
{
	...
	*/
	...
	{
		$data=$this->seguridad_model->consultar_permiso($this->session->userdata('id_usuario'),ROLES); /*Verificacion de permiso para administrara roles*/
	...
	*/
	...
	{
		$data=$this->seguridad_model->consultar_permiso($this->session->userdata('id_usuario'),ROLES);
	...
	*/
	...
	{
		$data=$this->seguridad_model->consultar_permiso($this->session->userdata('id_usuario'),USUARIOS); /*Verificacion de permiso para administrara usuarios*/
		$data['id_modulo']=USUARIOS;
		if($data['id_permiso']==3) {
			switch($data['id_permiso']) { /*Busqueda de informacion a mostrar en la pantalla segun el nivel del usuario logueado*/
				case 1:
	...
	*/
	...
	{
		$data=$this->seguridad_model->consultar_permiso($this->session->userdata('id_usuario'),USUARIOS); /*Verificacion de permiso para crear solicitudes*/
	...
	*/
	...
	{
		$data=$this->seguridad_model->consultar_permiso($this->session->userdata('id_usuario'),USUARIOS);
